    ...
    contextInfo: {
      externalAdReply: {
        ...
        renderLargerThumbnail: true
                                      ...
                                      } else conn.reply(m.chat, `Pastikan anggur kamu *500* untuk bisa meracik ramuan`, m, {
    contextInfo: {
      externalAdReply: {
        title: namebot,
        body: "",
        ...
        renderLargerThumbnail: true
                                   ...
                                   } else conn.reply(m.chat, `Pastikan jeruk kamu *500* untuk bisa meracik ramuan`, m, {
    contextInfo: {
      externalAdReply: {
        title: namebot,
        body: "",
        ...
        renderLargerThumbnail: true
                                ...
                                } else conn.reply(m.chat, `Pastikan pisang kamu *500* untuk bisa meracik ramuan`, m, {
    contextInfo: {
      externalAdReply: {
        title: namebot,
        body: "",
        ...
        renderLargerThumbnail: true
                             ...
                             } else conn.reply(m.chat, `Pastikan apel kamu *500* untuk bisa meracik ramuan`, m, {
    contextInfo: {
      externalAdReply: {
        title: namebot,
        body: "",
        ...
        renderLargerThumbnail: true
                          ...
                          } else conn.reply(m.chat, `Pastikan mangga kamu *500* untuk bisa meracik ramuan`, m, {
    contextInfo: {
      externalAdReply: {
        title: namebot,
        body: "",
...
`.trim()
                     ...
                     case 'potion':
                                     ...
                                     if (apele == 0 || anggure == 0 || manggae == 0 || pisange == 0 || jeruke == 0) return conn.reply(m.chat, message, m, {
    contextInfo: {
      externalAdReply: {
        title: namebot,
        body: "",
