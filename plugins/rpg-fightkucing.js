...
conn.level = global.db.data.users[m.sender]
  ...
  if (typeof conn.fightnaga[m.sender] != "undefined" && conn.fightnaga[m.sender] == true) return conn.reply(m.chat, `*Tidak bisa melakukan battle karena arena yg kamu miliki sedang kamu pakai .*`, m, {
    contextInfo: {
      externalAdReply: {
        title: namebot,
        body: "",
