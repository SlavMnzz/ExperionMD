...
conn.level = global.db.data.users[m.sender]
  ...
  conn.reply(m.chat, `*Pet Kamu* (🦊kyubi ${global.db.data.users[m.sender].kyubi}) ⚔️menantang 🦊kyubinya *${conn.getName(lawan)}* (🦊kyubi ${global.db.data.users[lawan].kyubi}) lagi berkelahi.\n\nTunggu ${lamaPertarungan} menit lagi dan lihat siapa yg menang🎮.`, m, {
    contextInfo: {
      externalAdReply: {
        title: namebot,
        body: "",
