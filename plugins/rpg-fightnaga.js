...
conn.level = global.db.data.users[m.sender]
  ...
  conn.reply(m.chat, `*Pet Kamu* (🐉naga ${global.db.data.users[m.sender].naga}) ⚔️menantang 🐉naganya *${conn.getName(lawan)}* (🐉naga ${global.db.data.users[lawan].naga}) lagi berkelahi.\n\nTunggu ${lamaPertarungan} menit lagi dan lihat siapa yg menang🎮.`, m, {
    contextInfo: {
      externalAdReply: {
        title: namebot,
        body: "",
