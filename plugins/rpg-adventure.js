    ...
    try {
        ...
        if (global.db.data.users[m.sender].health > 79) {
            if (new Date - global.db.data.users[m.sender].lastadventure > 3600000) {
                ...
                let str = `
Nyawa mu berkurang -${health * 1} karena Kamu telah berpetualang sampai ${pickRandom(['Hutan Valoria', 'Hutan Pendragon', 'Kerajaan Camelot', 'Hutan Excalibur', 'Hutan Merlindale', 'Hutan Avalon', 'Hutan Morgana', 'Hutan Tintagel', 'Kerajaan Arthur', 'Hutan Gwynedd', 'Hutan Percival', 'Hutan Moonlight', 'Zimbabwe', 'Gunung Everest', 'Palung Mariana', 'Bukit Tontarama', 'Hutan Isolde', '...'])} dan mendapatkan
*exp:* ${exp} 
*uang:* ${uang}
*tiketcoin:* 1
