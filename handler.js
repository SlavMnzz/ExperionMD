...
// Sekarang Anda dapat menggunakan cron dan WAConnection di dalam handler.js
...
contextInfo: {
     mentionedJid: [user],
      ...
      newsletterJid: '1203632527426219804@newsletter',
          newsletterName: "𝙶𝚃𝙶𝙽𝚉𝚉",
             serverMessageId: -1
         },
            forwardingScore: 256,
externalAdReply: {
...
let msg = {
 ...
 botAdmin: `*jadikan adel admin dulu*`,
 restrict: `*fitur ini di matiin*`
 }[type]
 if (msg) return conn.reply(m.chat, msg, fkontak, global.danied)
 let msgg = {
 unreg: "* Kamu Belum Daftar Silahkan Daftar Terlebih Dahulu Dengan Cara \nDaftar gerry.18"
 }[type]
